...
- El proyecto debe **dar soporte específico a La Rioja** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución riojana** a la que el software da soporte (p.ej. larioja.org, iderioja.larioja.org, unirioja.es). Esto ayuda a verificar que el proyecto es relevante para La Rioja.
