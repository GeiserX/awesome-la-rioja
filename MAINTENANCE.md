...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de La Rioja. No basta con que el autor sea de La Rioja o resida aquí. Un framework genérico creado por un developer de La Rioja no pertenece a esta lista. Un cliente para una API de servicios de La Rioja sí.
