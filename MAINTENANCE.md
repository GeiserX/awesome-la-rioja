...
El criterio fundamental es: **se acepta software que da soporte específico a La Rioja, no software hecho por alguien de La Rioja.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de La Rioja. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de La Rioja no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de La Rioja o una integración con servicios públicos de La Rioja sí.

- **Sí:** Clientes de APIs de instituciones de La Rioja, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de La Rioja.
- **No:** Librerías genéricas creadas por equipos de La Rioja, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a La Rioja** (no simplemente que el autor es de La Rioja).
2. Verificar que la PR incluye la **URL del servicio o institución de La Rioja** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-la-rioja`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de La Rioja |
